            ...
            <div className="rounded-lg border border-border bg-secondary/40 p-4 space-y-3">
              ...
              <div className="flex flex-wrap gap-2 pt-1 border-t border-border">
                <Button asChild size="sm">
                  <Link to={buildPracticePath({ scope: "topic", subject: mistakeInsight.subject, stream: mistakeInsight.stream, topic: mistakeInsight.topicSlug, mode: mistakeInsight.recommendedMode, source: "check", mistake: mistakeInsight.id })}>
