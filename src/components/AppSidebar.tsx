  ...
  return (
    <aside className="hidden lg:flex flex-col w-64 shrink-0 bg-sidebar text-sidebar-foreground border-r border-sidebar-border h-screen sticky top-0">
      ...
      <div className="px-4 py-4 border-t border-sidebar-border space-y-3">
        ...
        {/* Hidden prototype notes link (not visible as primary nav). */}
        <Link
          to="/app/notes"
          className="block text-[10px] uppercase tracking-wider text-sidebar-foreground/40 hover:text-sidebar-foreground/70 pt-1"
        >
          · Prototype notes
        </Link>
      </div>
